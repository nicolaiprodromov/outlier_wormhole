...
class TemplateComposer:
    def __init__(self, templates_dir: str = "templates", prompts_file="agent_prompts.yaml"):
    ...
    def initialize_system_prompt(self, tools=None, managed_agents=None, custom_instructions=None, 
                                rules=None, attachments=None, user_request=None):
        tools_list = []
        if tools:
            for tool in tools:
